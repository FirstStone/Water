...
- (CAKeyframeAnimation *)borderColorAnimation {
    ...
    borderColorAnimation.keyPath = @"borderColor";//9, 209, 90  //255, 216, 87 // 255, 231, 152 // 255, 241, 197
    borderColorAnimation.values = @[(__bridge id)SCor_RColor(9, 209, 90, 0.3).CGColor,
                                    (__bridge id)SCor_RColor(9, 209, 90, 0.2).CGColor,
                                    (__bridge id)SCor_RColor(9, 209, 90, 0.1).CGColor,
                                    (__bridge id)SCor_RColor(9, 209, 90, 0).CGColor];
...
- (CAKeyframeAnimation *)backgroundColorAnimation {
    ...
    backgroundColorAnimation.values = @[(__bridge id)SCor_RColor(9, 209, 90, 0.3).CGColor,
                                        (__bridge id)SCor_RColor(9, 209, 90, 0.2).CGColor,
                                        (__bridge id)SCor_RColor(9, 209, 90, 0.1).CGColor,
                                        (__bridge id)SCor_RColor(9, 209, 90, 0).CGColor];
